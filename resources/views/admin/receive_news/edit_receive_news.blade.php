    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <!-- /.card-header -->
                <form role="form" action="{{ url('admin/receive_news/edit') }}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" name="id" value="{{$receive_news->id}}">
                    <div class="card-body">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control" placeholder="สถานะการติดต่อเรา" name="status_id">
                                            <option value="1" @if($receive_news->status_id == 1) selected @endif>ยังไม่ได้ส่ง</option>
                                            <option value="2" @if($receive_news->status_id == 2) selected @endif>ส่งแล้ว</option>
                                        </select>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer">
                        <a class="btn btn-danger" href="{{ url('admin/receive_news') }}"><i class="fas fa-arrow-alt-circle-left"></i> ย้อนกลับ</a>
