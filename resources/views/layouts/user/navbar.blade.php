        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="{{ url('/') }}" class="nav-link navbarStyle @if(Request::is('/')) active @endif">หน้าแรก</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/activity') }}" class="nav-link navbarStyle @if(Request::is('activity*')) active @endif">กิจกรรม</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ url('/reward') }}" class="nav-link navbarStyle @if(Request::is('reward*')) active @endif">ของรางวัล</a>
                    </li>
{{--                    <li class="nav-item">--}}
...
{{--                    </li>--}}
                    @guest
                        <li class="nav-item">
                            <a class="nav-link navbarStyle" href="{{ route('login') }}">{{ __('เข้าสู่ระบบ') }}</a>
                        </li>
