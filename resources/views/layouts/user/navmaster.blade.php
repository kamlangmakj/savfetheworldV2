            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    @guest
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin-login') }}" class="nav-link navbarStyle @if(Request::is('admin-login')) active @endif">{{ __('เข้าสู่ระบบ [ADMIN]') }}</a>
                        </li>
...
{{--                        </li>--}}
                        @endif
                    @else
                        <li class="nav-item dropdown" style="border: 1px solid red;">
